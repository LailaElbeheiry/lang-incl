...
class BDD_NFA:
    ...
    def __init__(self, nfa1, nfa2):
        ...
        self.B_init = (initial2, self.bdd.add_expr(self.state_to_str(initial, vrs0[:k])))
        ...
        for state in transitions2:
            transitions2[state]['0'] = list(transitions2[state]['0'])
            transitions2[state]['1'] = list(transitions2[state]['1'])
